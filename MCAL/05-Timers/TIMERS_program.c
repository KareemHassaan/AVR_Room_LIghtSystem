...
/**************************************************************************************************************************************
* Function Name		: MTIMERS_VoidTimer0Enable 																	                      *
* Parameters (in)	: None																						                      *
* Parameters (out)	: None																						                      *
* Return value		: None																						                      *
* Description		: Function to Enable Timer0.							     								                      *
**************************************************************************************************************************************/
void MTIMERS_VoidTimer0Enable()
{
	SET_SPECIFIC_REG_BITS_VALUE(TCCR0,TIMER0_PRESCALLER_MASK,TIMER0_PRESCALLER_VALUE);
}

/**************************************************************************************************************************************
* Function Name		: MTIMERS_VoidTimer0Disable 																	                  *
* Parameters (in)	: None																						                      *
* Parameters (out)	: None																						                      *
* Return value		: None																						                      *
* Description		:  Function to Disable Timer0.							     								                      *
**************************************************************************************************************************************/
void MTIMERS_VoidTimer0Disable()
{
	 SET_SPECIFIC_REG_BITS_VALUE(TCCR0,TIMER0_PRESCALLER_MASK,T0_NO_CLOCK_SOURCE);
}
/**************************************************************************************************************************************
...
/**************************************************************************************************************************************
* Function Name		: MTIMERS_VoidTimer1Enable 																	                      *
* Parameters (in)	: None																						                      *
* Parameters (out)	: None																						                      *
* Return value		: None																						                      *
* Description		: Function to Enable Timer	1					.		     								                      *
**************************************************************************************************************************************/
void MTIMERS_VoidTimer1Disable()
{
	/*Setting Timer 1 Prescaller to No CLK Source To Disabel Timer 1*/
	SET_SPECIFIC_REG_BITS_VALUE(TCCR1B,TIMER1_PRESCALLER_MASK,T1_No_clock_source);
}
...
/**************************************************************************************************************************************
* Function Name		: MTIMERS_VoidTimer2Enable 																	                      *
* Parameters (in)	: None																						                      *
* Parameters (out)	: None																						                      *
* Return value		: None																						                      *
* Description		: Function to Enable Timer	1					.		     								                      *
**************************************************************************************************************************************/
void MTIMERS_VoidTimer2Disable()
{
	/*Disable Timer2 By Making No Clock coming*/
	SET_SPECIFIC_REG_BITS_VALUE(TCCR2,TIMER2_PRESCALLER_MASK,T2_NO_CLOCK_SOURCE);
}
...
* Description		: Function to Set Busy time as a Delay. 					  					       				              *
**************************************************************************************************************************************/
void MTIMERS_voidSetBusyWait2(uint32 Copy_u32MilliSeconds)
{
	/*
		Prescaler = 8;
		OCR0 = 250
	...
	*/
	/*Make Sure The Prescaler Is = 8*/
	 SET_SPECIFIC_REG_BITS_VALUE(TCCR2,TIMER2_PRESCALLER_MASK,T2_DIVIDE_BY_8);
